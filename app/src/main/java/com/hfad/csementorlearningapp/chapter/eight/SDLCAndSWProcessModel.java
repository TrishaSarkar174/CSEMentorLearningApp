...
public class SDLCAndSWProcessModel extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_sdlcand_swprocess_model);
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FSWE%2FSDLC%26SWProcessModel.pdf?alt=media&token=7a8637a0-be1c-4db7-9bc8-79eacb572617");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(SDLCAndSWProcessModel.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
