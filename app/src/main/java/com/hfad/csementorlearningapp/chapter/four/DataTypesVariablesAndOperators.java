...
public class DataTypesVariablesAndOperators extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_data_types_variables_and_operators);
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(DataTypesVariablesAndOperators.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
