...
public class IssueAndBugTracking extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_issue_and_bug_tracking);
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FSWE%2FIssueAndBugTracking.pdf?alt=media&token=557b8e09-48e0-40e5-992b-3b30d026f13c");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(IssueAndBugTracking.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
