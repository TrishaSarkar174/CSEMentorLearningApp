...
public class GreedyAlgorithms extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FAlgorithm1%2FGreedyAlgorithms.pdf?alt=media&token=bb3f58b5-0081-44e2-ab13-692e6d009b2c");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(GreedyAlgorithms.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
