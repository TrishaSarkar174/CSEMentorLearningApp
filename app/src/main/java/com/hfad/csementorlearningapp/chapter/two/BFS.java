...
public class BFS extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FAlgorithm1%2FBFS.pdf?alt=media&token=fcbf1e05-8a5f-413d-8ca5-01302146b53e");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(BFS.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
