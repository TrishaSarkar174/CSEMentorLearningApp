...
public class SCC extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FAlgorithm1%2FSCC.pdf?alt=media&token=675856f7-8388-4030-82c1-b4a0a16c6f3a");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(SCC.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
