...
public class IntroductionToCProgramming extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_introduction_to_cprogramming);
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(IntroductionToCProgramming.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
