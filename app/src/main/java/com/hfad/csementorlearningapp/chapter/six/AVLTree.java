...
public class AVLTree extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FAlgorithm2%2FAVLTree.pdf?alt=media&token=c9695f5d-1e70-4688-a070-395484e2c5d7");
