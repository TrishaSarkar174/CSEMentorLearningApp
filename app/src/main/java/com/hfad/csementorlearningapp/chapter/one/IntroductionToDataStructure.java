...
public class IntroductionToDataStructure extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FDataStructure%2FIntroductionToDataStructure.pdf?alt=media&token=6ad7196b-3242-4aeb-b453-8963266e448f");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(IntroductionToDataStructure.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
