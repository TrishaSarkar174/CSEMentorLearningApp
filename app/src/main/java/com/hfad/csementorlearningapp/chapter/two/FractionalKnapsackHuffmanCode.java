...
public class FractionalKnapsackHuffmanCode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_fractional_knapsack_huffman_code);
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FAlgorithm1%2FCoinChangeFractionalKnapsackHuffmanCode.pdf?alt=media&token=ef2672f0-0302-4c13-a07b-dd1267d94a41");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(FractionalKnapsackHuffmanCode.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
