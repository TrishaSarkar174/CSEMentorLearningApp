...
public class DynamicProgramming extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FAlgorithm1%2FDynamicProgramming.pdf?alt=media&token=1f40f1be-2ef2-4349-a2e8-1b48b467ebc4");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(DynamicProgramming.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
