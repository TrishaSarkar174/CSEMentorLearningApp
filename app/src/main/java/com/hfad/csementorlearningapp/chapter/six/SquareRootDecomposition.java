...
public class SquareRootDecomposition extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_square_root_decomposition);
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FAlgorithm2%2FSquareRootDecomposition.pdf?alt=media&token=4b7918d8-8faa-46bf-8ce7-c6e4255e9699");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(SquareRootDecomposition.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
