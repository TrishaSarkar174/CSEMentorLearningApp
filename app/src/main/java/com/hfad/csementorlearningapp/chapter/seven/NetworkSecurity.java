...
public class NetworkSecurity extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FCN%2FNetworkSecurity.pdf?alt=media&token=b2c75032-077d-4a8e-ab66-40811691c5bf");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(NetworkSecurity.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
