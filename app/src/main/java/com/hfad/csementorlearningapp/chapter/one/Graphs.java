...
public class Graphs extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FDataStructure%2FGraphs.pdf?alt=media&token=edd95d15-6af6-4023-a403-b55c2f39543d");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(Graphs.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
