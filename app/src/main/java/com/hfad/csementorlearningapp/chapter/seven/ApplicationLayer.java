...
public class ApplicationLayer extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FCN%2FApplicationLayer.pdf?alt=media&token=1858f58d-b2be-45e9-9365-67dc7c41cc36");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(ApplicationLayer.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
