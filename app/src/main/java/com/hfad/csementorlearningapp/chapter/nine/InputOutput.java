...
public class InputOutput extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FComputerArchitecture%2FInputOutput.pdf?alt=media&token=f8375ca9-1247-4884-87eb-6f100ca14719");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(InputOutput.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
