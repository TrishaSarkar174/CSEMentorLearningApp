...
public class SortingAlgorithms extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FDataStructure%2FSorting.pdf?alt=media&token=55e38d03-fdce-49e4-96f2-c366629bfc57");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(SortingAlgorithms.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
