...
public class BinaryIndexedTree extends AppCompatActivity {
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FAlgorithm2%2FBinaryIndexedTree.pdf?alt=media&token=4d2f3afa-a5f1-40e1-b146-a2f538407a17");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(BinaryIndexedTree.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
