...
public class InstructionLevelParallelism extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_instruction_level_parallelism);
    ...
    private void loadPdfFromFirebase() {
        ...
        storageReference = firebaseStorage.getReferenceFromUrl("https://firebasestorage.googleapis.com/v0/b/csementorlearningapp.appspot.com/o/CourseDetailsPdf%2FComputerArchitecture%2FInstructionLevelParallelism.pdf?alt=media&token=ce8ac140-8435-4a13-b99c-ca1823fdcec7");
        ...
        try {
            ...
            storageReference.getFile(localFile).addOnSuccessListener(new OnSuccessListener<FileDownloadTask.TaskSnapshot>() {
                ...
                public void onFailure(@NonNull Exception exception) {
                    Toast.makeText(InstructionLevelParallelism.this, "Failed to load PDF", Toast.LENGTH_SHORT).show();
